...
# data = cur.execute("SELECT* from shuju WHERE 标题 LIKE '%%%s%%'" %  输入)
# for item in range(data):
#     print(item)
# -*- coding: cp936 -*-

# for item in data1:
#     list1 = data1.pop(0).get_text().strip('\nTitle: ')
#     sql = 'INSERT INTO shuju(标题) VALUES (%s)'
#     values = list1
#     print(list1)
#     cur.executemany(sql, values)
#     db.commit()
...
# import re
# url1 = soup.select('#plugin')
# print(re.findall(r'src=.*\stype=',str))

# import urllib.request
# import re
#
# BASE_URL = 'https://arxiv.org/list/cs.AI/pastweek?show=164'
# html = requests.get(BASE_URL).text
# BOOK_LINK_PATTERN = re.compile('src="(.*)" type=>')
# list = re.findall(BOOK_LINK_PATTERN,html)
# for lianjie in list:
#     print(lianjie)

# import requests
#
# r = requests.get(BOOK_LINK_PATTERN)
# print(BOOK_LINK_PATTERN)
# with open('D:\pythonProject8\Artificial Intelligence.pdf','wb') as f:
#     f.write(r.content)